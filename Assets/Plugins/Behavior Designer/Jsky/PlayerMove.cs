...
namespace BehaviorDesigner.Runtime.Tasks.Jsky
{
  ...
  {
    [Tooltip("target")] public SharedGameObject target;
    [Tooltip("speed")] public float speed;
    [Tooltip("break space")] public float space = 0.05f;
    ...
    public override TaskStatus OnUpdate()
    {
      ...
      var movePostion =
        Vector3.MoveTowards(transform.position, target.Value.transform.position, speed * Time.deltaTime);
